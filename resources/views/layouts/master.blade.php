...
<head>
    ...
    <meta name="description" content="Clap Academy Portfolio">
    <meta name="keywords" content="Job, Resume, Employer, Agency">
    <link rel="canonical" href="#">
    <meta name="robots" content="index, follow">
    <!-- for open graph social media -->
    <meta property="og:title" content="Clap Academy Portfolio">
    <meta property="og:description" content="Clap Academy Portfolio">
    ...
    <meta name="twitter:title" content="Clap Academy Portfolio">
    <meta name="twitter:description" content="Clap Academy Portfolio">
    <!-- fabicon -->
    ...
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@200..800&amp;display=swap"
        rel="stylesheet">
    <link rel="shortcut icon" href="{{asset('assets/img/favicon-16x16.png')}}" type="image/x-icon">
    <title>Clap Academy - Portfolio &amp; Job Seeker and employee</title>
    <!-- rt icons -->
