...
class UserProfileComponent extends Component
{
    ...
    return view('livewire.user.user-profile-component', ['user_details' => $user, 'social_details' => $social_links, 'work_experience' => $work_experience, 'user_education' => $education, 'preference' =>$system_links])
